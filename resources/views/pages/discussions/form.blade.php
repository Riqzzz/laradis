                            ...
                            <div class="col-12">
                                <form action="" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" name="content" id="content" autofocus></textarea>
                                    </div>
                                    <div>
...
@section('after-script')
    <script>
        $(document).ready(function() {
            $('#content').summernote({
                placeholder: 'The details of your problem | What did you try | What you were expectating',
                tabSize : 2,
                height : 320,
                toolbar : [
                    ['style', ['style']],
